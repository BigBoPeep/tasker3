...
import WorkspaceUI from "./components/WorkspaceUI/WorkspaceUI";
...
function App() {
  return (
    <>
      <WorkspaceUI workspaces={workspaces} projects={projects} />
    </>
  );
}
    ...
    case "delete": {
      switch (data.targetType) {
        ...
        case "task": {
          ...
          projs[data.projectID].taskIDs = projs[data.projectID].taskIDs.filter(
            (tID) => tID !== data.taskID,
          );
          tasks.value = tsks;
          projects.value = projs;
